...
train_dataset = ImageDataset("/home/work/Dacon/open/train_input", "/home/work/Dacon/open/train_gt")
...
for epoch in range(epochs):
    ...
    with tqdm(total=len(train_loader), desc=f"Epoch {epoch+1}/{epochs}", unit="batch") as pbar:
        for input_images, gt_images in train_loader:
            ...
            # With this: Label Smoothing 추가
            real_labels = torch.full_like(discriminator(gt_images), 0.9).to(device)  # Smoothing real labels to 0.9
            fake_labels = torch.zeros_like(discriminator(input_images)).to(device)
    ...
    test_input_dir = "/home/work/Dacon/open/test_input"
